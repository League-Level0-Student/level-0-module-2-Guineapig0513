...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
		...
		String fourAsString = JOptionPane.showInputDialog("Type the number 4 please just please do it.");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
		String sixAsString = JOptionPane.showInputDialog("Type the number 6 now please do it if you dont you cant play this game>:(.");
		...
		String fiveAsString = JOptionPane.showInputDialog("Now, type 5 to continue please.");
			// 6) Print the addition of the variables fourAsString, sixAsString, and fiveAsString 
		JOptionPane.showInputDialog(fourAsString+fiveAsString+sixAsString);
		...
		JOptionPane.showInputDialog(fiveAsInt+sixAsInt+fourAsInt);
		JOptionPane.showInputDialog("YOU HAVE BEEN FOOLED!! You have been part of this expriment >:) Welp but thank you!");
